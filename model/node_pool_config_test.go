...
func nodePoolWithCount(n int) NodePoolConfig {
...
func nodePoolWithMinSize(n int) NodePoolConfig {
	return NodePoolConfig{
...
func nodePoolWithMaxSize(n int) NodePoolConfig {
	return NodePoolConfig{
		AutoScalingGroup: AutoScalingGroup{
			MaxSize: n,
		},
...
func nodePoolWithCountAndMinInService(n int, minInService int) NodePoolConfig {
	return NodePoolConfig{
		EC2Instance: EC2Instance{
			Count: n,
		},

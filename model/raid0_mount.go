...
func ValidateRaid0Mounts(volumes []VolumeMount, raid0s []Raid0Mount) error {
	paths := make(map[string]bool)
	devices := make(map[string]bool)

	// Populate any existing VolumeMount items (assumes they're already Validated themselves).
